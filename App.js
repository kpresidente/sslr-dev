...
const filesLoaded = (() => {
    ...
    if (window.devMode) {
        files = {
            Archives: `https://dl.dropbox.com/s/nnbxgjk8574vcix/Archives.js`,
            ClearZeros: `https://dl.dropbox.com/s/3bxz51afs8n30va/ClearZeros.js`,
            Collection: `https://dl.dropbox.com/s/f8fba5sd9yck4en/Collection.js`,
            CopyRecord: `https://dl.dropbox.com/s/8i5gc5nsus61mlr/CopyRecord.js`,
            DateRange: `https://dl.dropbox.com/s/pz5zg04a4szk2jf/DateRange.js`,
            Displayed: `https://dl.dropbox.com/s/00ruyiy074vf35a/Displayed.js`,
            Documents: `https://dl.dropbox.com/s/pg23b868388z5ew/Documents.js`,
            Dropbox: `https://unpkg.com/dropbox/dist/Dropbox-sdk.min.js`,
            Emails: `https://cdn.emailjs.com/dist/email.min.js`,
            Invoices: `https://dl.dropbox.com/s/5hmoxzqinq7govp/Invoices.js`,
            Maintenance: `https://dl.dropbox.com/s/384vpkkdcfjoksh/Maintenance.js`,
            MiniPDF: `https://dl.dropbox.com/s/f6pn2n5vxb85kom/minipdf.js`,
            PDFForm: `https://dl.dropbox.com/s/tvzq4jc85rurv0r/pdfform.js`,
            Pako: `https://dl.dropbox.com/s/ivp2l1dm8kos4pm/Pako.js`,
            ProjectFolder: `https://dl.dropbox.com/s/tlf9hbrnza34245/ProjectFolder.js`,
            Records: `https://dl.dropbox.com/s/ouy0uwssf1vogbn/Records.js`,
            Recurring: `https://dl.dropbox.com/s/ctlc8gnb860i4z7/Recurring.js`,
            UniqueNumber: `https://dl.dropbox.com/s/ct4ydfv4zsdh9nm/UniqueNumber.js`,
            UnitPrice: `https://dl.dropbox.com/s/t4lzfrc4vajtd4p/UnitPrice.js`,
            Witholding: `https://dl.dropbox.com/s/6rhsegi6x1md0xb/Witholding.js`
        }
    } else {
        files = {
            Archives: `https://dl.dropbox.com/s/4o1p9bn7egk0ycj/Archives.min.js`,
            ClearZeros: `https://dl.dropbox.com/s/r13l40wvvecy5sa/ClearZeros.min.js`,
            Collection: `https://dl.dropbox.com/s/e9tc98gvz6qcuj3/Collection.min.js`,
            CopyRecord: `https://dl.dropbox.com/s/hu94l7r9fig8ju2/CopyRecord.min.js`,
            DateRange: `https://dl.dropbox.com/s/uaoq9f774yivtgp/DateRange.min.js`,
            Displayed: `https://dl.dropbox.com/s/gnmtg1wnswoteud/Displayed.min.js`,
            Documents: `https://dl.dropbox.com/s/ejexrosu90s617o/Documents.min.js`,
            Dropbox: `https://unpkg.com/dropbox/dist/Dropbox-sdk.min.js`,
            Emails: `https://cdn.emailjs.com/dist/email.min.js`,
            Invoices: `https://dl.dropbox.com/s/1xwulp1gd5zppzg/Invoices.min.js`,
            Maintenance: `https://dl.dropbox.com/s/zc1o6vfbpva7qa3/Maintenance.min.js`,
            MiniPDF: `https://dl.dropbox.com/s/ssxj9h9r58jtlma/minipdf.min.js`,
            PDFForm: `https://dl.dropbox.com/s/5y93o5usuxkp4n5/pdfform.min.js`,
            Pako: `https://dl.dropbox.com/s/ivp2l1dm8kos4pm/Pako.js`,
            ProjectFolder: `https://dl.dropbox.com/s/lzri86gxxolfgmn/ProjectFolder.min.js`,
            Records: `https://dl.dropbox.com/s/3w0rnv2nivymd3s/Records.min.js`,
            Recurring: `https://dl.dropbox.com/s/iu7gyjdbzolkl21/Recurring.min.js`,
            UniqueNumber: `https://dl.dropbox.com/s/9axri7w2u7jsrmr/UniqueNumber.min.js`,
            UnitPrice: `https://dl.dropbox.com/s/9nojifgje9wbtpm/UnitPrice.min.js`,
            Witholding: `https://dl.dropbox.com/s/6rhsegi6x1md0xb/Witholding.js`
        }
    }
